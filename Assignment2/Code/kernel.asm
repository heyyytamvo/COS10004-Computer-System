...
;;;;;;r0 -  the size of the array (i.e., the number of values inside  the input array (also defined in INIT.asm)
;;;;;;r1 -  the memory address of the input array (i.e., inputarray defined in INIT.asm)
